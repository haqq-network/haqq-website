  ...
  return (
    <Fragment>
        ...
        <div className="flex max-w-[400px] flex-col sm:flex-1">
          ...
          <div className="mt-[4px] w-fit text-[12px] text-white">
            ...
            <Link
              ...
              className="text-haqq-orange transition-colors duration-300 hover:text-haqq-light-orange"
            >
              Privacy Policy
            </Link>
          </div>
      ...
      <Modal onClose={handleSuccessModalClose} isOpen={isSuccessModalOpen}>
        <div className="relative flex max-w-[343px] items-center justify-between rounded-[10px] bg-white px-[16px] text-haqq-black sm:max-w-[473px] sm:px-[32px] lg:max-w-[623px] lg:px-[62px]">
