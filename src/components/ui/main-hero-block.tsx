...
export function MainHeroBlock() {
  return (
    <div className="relative overflow-x-clip border-b border-haqq-border">
      <div
        className={clsx(
          'z-10 flex flex-col items-start justify-center border-haqq-border',
          ...
          <p>
            <Text size="large">
              <Link
                ...
                className="underline transition-colors duration-150 hover:text-haqq-orange"
              >
                Islamic Coin
              </Link>{' '}
