    ...
    <span className="group relative inline-block leading-none">
      ...
      <div
        className={clsx(
          ...
          'rounded-[4px] p-[8px] font-guise text-[12px] font-[500] leading-[18px] shadow-sm',
          'mb-[4px] transform-gpu border border-[#FFFFFF26] bg-haqq-black bg-opacity-90 text-white backdrop-blur',
          className,
        )}
      >
        {text}
