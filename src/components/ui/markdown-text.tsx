...
export function MarkdownText({
  ...
  return (
    <div
      className={clsx(
        'prose prose-base max-w-none xl:prose-lg',
        ...
        'font-guise prose-headings:font-clash prose-headings:font-[500]',
        'prose-img:w-full',
        'prose-h1:mt-[1.87em]',
        isBlack
          ? 'text-haqq-black prose-headings:text-haqq-black prose-blockquote:text-haqq-black prose-strong:text-haqq-black marker:prose-li:text-haqq-black'
          : 'text-white prose-headings:text-white prose-blockquote:text-white prose-strong:text-white marker:prose-li:text-white',
        className,
      )}
    >
      <ReactMarkdown
