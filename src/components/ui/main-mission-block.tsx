...
export function MainMissionBlock() {
  return (
    <div
      className="relative flex h-[326px] flex-col items-center justify-center bg-white px-[16px] text-haqq-black sm:h-[464px] sm:px-[63px] lg:h-[600px] lg:pl-[79px] lg:pr-[80px]"
      id="mission"
    >
      ...
      <div className="mx-[44px] text-center sm:max-w-xs lg:max-w-3xl">
        <Heading level={2}>
          ...
          crypto prevent mass adoption. HAQQ&apos;s mission is to make Web3
