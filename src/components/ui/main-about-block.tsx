...
export function MainAboutBlock() {
  return (
    <div
      className="mx-[16px] flex flex-col border-l border-haqq-border px-[16px] pb-[60px] sm:ml-[63px] sm:mr-0 sm:flex-row sm:pb-0 sm:pl-0 sm:pr-0 lg:ml-[79px]"
      id="about"
    >
      <div className="py-[60px] sm:w-1/3 sm:px-[20px] sm:py-[60px] lg:px-[32px] lg:py-[140px] xl:w-2/5">
        <Heading level={2}>About HAQQ</Heading>
      </div>
      <div className="flex-1 border-haqq-border py-[16px] sm:border-l sm:py-[60px] sm:pl-[22px] sm:pr-[64px] lg:py-[150px] lg:pl-[32px] lg:pr-[80px]">
