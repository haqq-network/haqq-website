  ...
  return (
    <div className={classNames}>
      <div className="flex flex-row items-center justify-between">
        ...
        <svg
          className="transition-color h-[12px] w-[12px] text-haqq-border duration-150 ease-in group-hover:text-haqq-orange sm:h-[20px] sm:w-[20px]"
          viewBox="0 0 22 23"
          fill="none"
...
export function MainDevelopersBlock() {
  return (
    <div
      className="ml-[16px] border-l border-haqq-border px-[16px] sm:ml-[63px] sm:pl-[20px] sm:pr-[64px] lg:ml-[79px] lg:pl-[32px] lg:pr-[80px]"
      id="developers"
    >
