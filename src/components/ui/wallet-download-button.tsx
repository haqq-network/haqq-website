  ...
  return (
    <div
      className={clsx(
        ...
        isAvailable &&
          'cursor-pointer bg-white text-haqq-black hover:text-[#01B36E] hover:shadow-xl',
...
export function WalletDownloadWithQrButton({
  ...
  return (
    <Popover open={isHovered} placement="right">
      ...
      >
        <div
          className={clsx(
            ...
            'bg-white text-haqq-black hover:text-[#01B36E] hover:shadow-xl',
          )}
        >
          {type === 'apple' && <AppStoreLogoIcon />}
          {type === 'google' && <GooglePlayLogoIcon />}
      ...
      <PopoverContent className="transform-gpu rounded-lg border border-[#FFFFFF26] bg-haqq-black bg-opacity-90 p-4 text-white shadow-lg outline-none backdrop-blur">
