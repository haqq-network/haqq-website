...
export function Footer() {
  ...
  return (
    <footer
      className={clsx(
        'z-[100] flex flex-col border-b border-t border-haqq-border bg-haqq-black',
      )}
    >
      <div className="flex h-[63px] w-full flex-row items-center border-b border-haqq-border sm:h-[72px] lg:mx-auto">
        <div className="flex h-full w-[48px] items-center justify-center border-r border-haqq-border sm:w-[64px] lg:w-[80px]">
        ...
        <div className="ml-[12px] font-clash text-[20px] font-medium leading-none sm:ml-[20px] sm:text-[24px] lg:ml-[32px]">
          <Link href="/">HAQQ</Link>
        </div>
      </div>
      <div className="flex w-full flex-col lg:mx-auto lg:flex-row">
        <div className="flex flex-row border-b border-haqq-border lg:h-auto lg:border-b-0">
          <div className="ml-[16px] flex-1 border-l border-r border-haqq-border py-[24px] pl-[16px] sm:ml-[63px] sm:px-[34px] sm:py-[56px] lg:ml-[79px] lg:w-[212px]">
