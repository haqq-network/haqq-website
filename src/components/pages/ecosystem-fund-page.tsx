...
import linesSmallBgData from '@/assets/images/fund-hero-block-bg-small.svg';
import linesBgData from '@/assets/images/fund-hero-block-bg.svg';
import { Button } from '../ui/button';
import { EcosystemFundApplyBlock } from '../ui/ecosystem-fund-apply-block';
      ...
      <div className="border-b border-t border-white/20 px-[16px] py-[60px] sm:px-[48px] sm:py-[80px] lg:px-[110px] lg:py-[100px] xl:px-[320px]">
        <div className="flex flex-col gap-y-[20px] sm:gap-y-[24px]">
          ...
          <Text>
            ...
            improving the HAQQ Ecosystem&apos;s growth. Our grants and
            investments undergo a stringent ethics and Shariah assessment to
            ensure that every project funded aligns with our Islamic values and
            is ethical in its general sense.
          </Text>
          <Text>
