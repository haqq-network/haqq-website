...
export function ValidatorProgramPage() {
  return (
    <section className="overflow-x-clip">
      ...
      <div className="border-t border-t-[#2a2a2b] bg-haqq-black px-[16px] py-[60px] text-white md:px-[48px] md:py-[80px] lg:px-[110px] lg:py-[100px]">
        <div className="mx-auto flex max-w-4xl flex-col xl:max-w-5xl">
          ...
          <h3 className="mt-[36px] font-clash text-[14px] font-[500] leading-[18px] md:mt-[48px] md:text-[16px] md:leading-[22px] lg:mt-[64px] lg:text-[20px] lg:leading-[26px]">
          ...
          <div className="mt-[36px] font-clash text-[14px] leading-[18px] md:mt-[48px] md:text-[16px] md:leading-[22px] lg:mt-[48px] lg:text-[20px] lg:leading-[26px]">
            Benefits of being a validator
          </div>
