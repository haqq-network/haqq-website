...
export function AuditsPage() {
  return (
    <section className="overflow-x-clip">
      ...
      <div className="flex flex-col bg-white px-[16px] py-[68px] text-haqq-black md:px-[48px] md:pb-[130px] md:pt-[100px] lg:px-[80px] lg:py-[140px]">
        <div className="relative flex items-center">
          <Heading>HAQQ audits</Heading>
          <div className="ml-[48px] flex items-center">
            <div className="h-[16px] w-[16px] bg-haqq-black" />
...
function AuditCard({ logo, name, report }: Auditor) {
  return (
    <div className="flex flex-col border border-[#0D0D0E4D] p-[20px]">
      ...
      <div className="text-[12px] leading-[18px] text-haqq-black">{name}</div>
      <Link
        className="mt-[12px] flex w-fit flex-row items-center gap-x-[4px] text-[14px] font-[500] uppercase leading-[22px] text-haqq-orange transition-colors duration-300 hover:text-haqq-light-orange"
        href={report}
        target="_blank"
